...
export const YandexAdapter = {
  ...
  // Please, use ysdk.leaderboards» — реальная находка красной команды 05.08, не косметика:
  // это ERROR, не warning, и B7 требует чистую консоль на каждом шаге). Проверено
  // документацией Яндекса (yandex.ru/dev/games/doc/dg/sdk/sdk-leaderboard) перед заменой.
  leaderboard: {
