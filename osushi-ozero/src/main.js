...
async function start() {
  ...
  // ФРЕЙМ ПОД ИГРУ. Площадка даёт окно своего размера, и портретная игра в альбомном
  // фрейме — это пустые поля по бокам (отказ VK 02.08). Просим окно под пропорции игры;
  // умеет только VK-десктоп, остальные вернут null и мы просто подстроимся сами.
  await Platform.fitFrame(BASE_WIDTH / BASE_HEIGHT);
